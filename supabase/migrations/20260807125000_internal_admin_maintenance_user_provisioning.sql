create policy organizations_select_internal_admin
on public.organizations
for select
to authenticated
using (private.is_internal_admin(auth.uid()));

create or replace function public.finalize_provisioned_maintenance_user(
