...
begin
  ...
  return query
    ...
    group by team.id, branch.id, branch.name, team.supervisor_user_id, profile.full_name, auth_user.email, team.active
    order by branch.name, profile.full_name, auth_user.email, team.id
    limit 500;
end;
$$;
