#!/usr/bin/env node
/**
 * Isolated test runner for Phase 3B2 Daily Waste.
 *
...
const DISPOSABLE_DB_NAME = 'phase3b2_test_disposable';
...
console.log('\x1b[34m  PHASE 3B2 DAILY WASTE DISPOSABLE TEST RUNNER\x1b[0m');
console.log('\x1b[34m====================================================\x1b[0m');
...
// Step 4: Apply Phase 3B2 Daily Waste
runSqlInDisposableDb('supabase/migrations/20260910110000_daily_waste_phase3b2.sql');

// Step 5: Run pgTAP test suite
console.log('\x1b[36m--> Running pgTAP test suite: supabase/tests/database/daily_waste_phase3b2.test.sql...\x1b[0m');
const tapOutput = runSqlInDisposableDb('supabase/tests/database/daily_waste_phase3b2.test.sql');
